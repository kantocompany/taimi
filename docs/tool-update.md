...
8. **Notes style** — Keep notes terse and factual. No marketing copy, no trailing periods. Match the style of existing tool files. Do not remove terms from existing notes unless the vendor discontinued the feature — compound terms like "SSO/OIDC" are intentional
