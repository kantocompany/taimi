...
Card rule: a feature added to a plan's notes must be confirmable from that plan's own card or section on the page. If you can find it only in a comparison table or another plan's card, mark confirmed: false — table attribution is unreliable in this render.
